  ...
  <div className="const_bg">
   ...
   <ul>
    ...
    <li>
     ...
     <br />
     <br />
     ➧ &nbsp; &nbsp; Elección de un protocolo dedicado a las crisis
     psico-emocionales y asignación de equipos y/o roles
     <br />
     <br />
     ➧ &nbsp; &nbsp; Capacitación de las brigadas de respuesta
     <br />
    ...
    <li>
     ...
     <br />
     <br />
     ➧ &nbsp; &nbsp; Brindar seguridad psicológica. La seguridad psicológica se
     puede definir como un entorno en el que las personas se sienten seguras de
     ser ellas mismas, de tomar decisiones, de no estar de acuerdo, ofrecer
     diferentes puntos de vista, cometer errores, admitir esos errores y
     experimentar con acciones no probadas
     <br />
     <br />➧ &nbsp; &nbsp; No se puede hablar de verdadera seguridad psicológica
     si no se acompañan con medidas administrativas conducentes. Un buen
     ejemplo, es el cumplimiento de la confidencialidad de la intervención. Otro
